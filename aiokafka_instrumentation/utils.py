...
ConsumeHookT = Optional[Callable[[Span, Any, List, Dict], None]]
...
class KafkaContextSetter(textmap.Setter[textmap.CarrierT]):
    def set(self, carrier: textmap.CarrierT, key: str, value: str) -> None:
        ...
        if value:
            value = value.encode()  # type: ignore
    ...
    span.set_attributes(
        {
            ...
            SpanAttributes.MESSAGING_CLIENT_ID: client_id,
        }
    )
...
def _wrap_next(
    ...
    async def _traced_next(func, instance, args, kwargs):
